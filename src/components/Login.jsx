      ...
      <div className="container mx-auto">
        ...
        <div className="flex items-center justify-center mt-22">
          <button
            ...
            className="flex cursor-pointer items-center gap-3 bg-google-button-dark hover:bg-google-button-dark/80 rounded-full p-1 pr-4 transition-colors duration-300 hover:bg-google-button-dark-hover"
          >
